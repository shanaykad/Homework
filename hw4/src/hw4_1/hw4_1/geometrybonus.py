...
class Geometry(Node):
    def __init__(self):
        ...
        self.publisher_tri = self.create_publisher(Twist, 'turtlesim1/triangleturtle/cmd_vel', 10)
        self.publisher_squ = self.create_publisher(Twist, 'turtlesim1/squareturtle/cmd_vel', 10)
        self.publisher_dec = self.create_publisher(Twist, 'turtlesim1/decagonturtle/cmd_vel', 10)
        self.publisher_cir = self.create_publisher(Twist, 'turtlesim1/circleturtle/cmd_vel', 10)
    ...
    def draw_circle(self):
        self.spawn_turtle(8.0, 1.0, 'circleturtle')
        msg = Twist()
        msg.linear.x = 0.5
        msg.angular.z = 0.5
        self.publisher_cir.publish(msg)
        time.sleep(2*math.pi/msg.angular.z)
        self.kill_turtle('circleturtle')
